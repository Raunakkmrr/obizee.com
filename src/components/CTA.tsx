...
const CTA = () => {
  return (
    <section
      className="py-24 bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 relative overflow-hidden"
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <Building className="w-5 h-5 text-white mr-2" aria-hidden="true" />
          <span className="text-white font-medium">Join 50K+ Growing Businesses</span>
          <Zap className="w-4 h-4 text-yellow-300 ml-2" aria-hidden="true" />
        </div>

        <h2 id="cta-heading" className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight">
        ...
        <p className="text-xl md:text-2xl text-orange-100 mb-12 max-w-4xl mx-auto leading-relaxed">
          ...
          transformation today with our generous bonus offer.
        </p>

        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16" role="group" aria-label="Call to action buttons">
          <Link to="/signup">
            <Button
              size="lg"
              className="bg-white text-orange-600 hover:bg-gray-100 px-12 py-4 text-xl font-bold rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300"
              aria-label="Claim your ₹500 bonus"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto" role="list" aria-label="Offer benefits">
          <div className="flex items-center justify-center bg-white/10 rounded-2xl p-6 backdrop-blur-sm" role="listitem">
        ...
        {/* Trust indicators */}
        <div className="mt-16 pt-8 border-t border-white/20" role="complementary" aria-label="Trust indicators">
          <p className="text-orange-100 mb-6">Trusted by leading businesses across India</p>
          <div className="flex justify-center items-center space-x-12 opacity-70" role="list" aria-label="Business statistics">
            <div className="text-white font-bold text-lg" role="listitem">
              50K+ Users
            </div>
            <div className="text-white font-bold text-lg" role="listitem">
              99.9% Uptime
