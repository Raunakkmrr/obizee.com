          ...
          {journeySteps.map((step, index) => (
            <div key={index} className={`flex items-center ${index % 2 === 1 ? 'flex-row-reverse' : ''}`}>
              <div className="flex-1">
                <div className={`bg-white rounded-3xl p-10 shadow-lg border border-gray-100 ${index % 2 === 1 ? 'ml-8' : 'mr-8'}`}>
                  <div className="flex items-center mb-6">
                    <div className={`w-20 h-20 bg-gradient-to-br ${step.color} rounded-2xl flex items-center justify-center mr-6`}>
              ...
              <div className="flex-shrink-0 relative">
                <div className={`w-24 h-24 bg-gradient-to-br ${step.color} rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-xl`}>
                  {step.step}
                </div>
