...
const journeySteps = [
  ...
  { icon: Truck, step: "04", title: "Logistics & Shipping", description: "Integrate Delhivery & DTDC. Generate AWB, schedule pickups, track deliveries.", features: ["Delhivery integration", "DTDC integration", "Live customer tracking"], href: "/business-journey#step-04", color: "from-green-500 to-emerald-500" },
