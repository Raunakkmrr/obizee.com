    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "You pay 1% per successful order until the fee reaches ₹10. For example: ₹100 order = ₹1, ₹500 = ₹5, ₹1000 = ₹10, and ₹2000+ still remains capped at ₹10.",
        },
      ],
    },
    {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        {/* Resources */}
        <section id="video-tutorials" className="py-16 scroll-mt-24" aria-labelledby="resources-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
