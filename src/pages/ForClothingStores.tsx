...
const ForClothingStores = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Setting up is free. Once your store has taken ₹50,000 in orders, you pay 1% per order with a maximum cap of ₹10. Even on a ₹10,000 designer outfit, you only pay ₹10.",
    },
    {
