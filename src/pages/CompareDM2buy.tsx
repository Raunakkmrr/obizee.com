  ...
  const comparisonGroups: ComparisonGroup[] = [
    ...
    },
    {
      ...
      rows: [
        ...
        { feature: "Auto-generated website", obizee: { s: "yes", t: "yourname.obizee.com, live in 2 minutes" }, rival: { s: "yes", t: "A hosted catalog page" } },
        { feature: "Custom order forms", obizee: { s: "yes", t: "Your own fields — size, flavour, delivery date, engraving" }, rival: { s: "no", t: "Fixed catalog checkout" } },
    ...
    },
    {
      ...
      rows: [
        { feature: "Order lifecycle dashboard", obizee: { s: "yes", t: "Pending → in progress → shipped → delivered, per order" }, rival: { s: "partial", t: "A list of orders received" } },
