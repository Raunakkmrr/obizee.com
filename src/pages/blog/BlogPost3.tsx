  ...
  return (
    ...
    >
      ...
      <div className="not-prose my-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <ThemeCard icon={IndianRupee} title="Affordable Pricing" description="For businesses doing 30-100 orders/month, paying ₹2,000/month for Shopify doesn't make sense. oBizee has 0 SUBSCRIPTION and 0 SETUP FEE." />
