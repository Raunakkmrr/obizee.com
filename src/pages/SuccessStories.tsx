  ...
  const successStories = [
    {
      ...
      quote: "StreamFlow transformed my small Instagram business into a professional operation. The inventory management alone saved me hours every day!",
    ...
    },
    {
      ...
      quote: "The automated inventory alerts help me plan for seasonal demands. I never run out of stock anymore, and billing is so much faster.",
      image: '/placeholder.svg'
    },
    {
      ...
      quote: "The analytics help me understand my customers better. I can now predict trends and stock accordingly. It's like having a business consultant built-in!",
      image: '/placeholder.svg'
    },
    {
    ...
    },
    {
      ...
      quote: "Custom projects are complex, but StreamFlow keeps everything organized. My clients love the professional communication and timely updates.",
      image: '/placeholder.svg'
    },
    {
      ...
      quote: "The subscription management is perfect for my nutrition programs. Customer retention insights help me provide better service.",
      image: '/placeholder.svg'
    }
  ];
            ...
            {successStories.map((story, index) => (
              ...
              >
                ...
                <div className="lg:w-1/2 space-y-6">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900">{story.businessName}</h2>
                  ...
                  <blockquote className="text-xl text-gray-700 italic border-l-4 border-orange-500 pl-6">
                    "{story.quote}"
                  </blockquote>
                ...
                <div className="lg:w-1/2">
                  <div className="bg-gradient-to-br from-orange-100 to-orange-50 rounded-3xl p-8 text-center">
                    ...
                    <div className="mt-6">
                      <h3 className="text-xl font-bold text-gray-900">{story.businessName}</h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm">
            ...
            <ul className="text-left text-gray-600 space-y-2 mb-8 max-w-2xl mx-auto">
            ...
            <Button className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-8 py-3 rounded-xl">
              Submit Your Story
      ...
      <section className="py-16 bg-gradient-to-r from-orange-500 to-orange-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-orange-100 mb-8">
            Join thousands of successful businesses and start your transformation today.
          </p>
