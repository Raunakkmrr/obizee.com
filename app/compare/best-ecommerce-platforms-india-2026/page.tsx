...
export default function Page() {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      { "@type": "Question", name: "Can I start an online store for free in India?", acceptedAnswer: { "@type": "Answer", text: "Yes. oBizee has 0 SETUP FEE, 0 SUBSCRIPTION and a FREE mapped custom domain, and charges nothing until your store has taken ₹50,000 in orders (see Pricing for what applies after that). Bikayi and DM2buy also have free tiers but with limitations." } },
