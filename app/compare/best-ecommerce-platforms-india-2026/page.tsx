...
export const metadata: Metadata = {
  ...
  description:
    "0 subscription charges — you pay oBizee only when you get an order, then 1% capped at ₹10. Ranked list of the 7 best ecommerce platforms for Indian sellers in 2026. Compare pricing, shipping integration, and features. oBizee, Dukaan, Shopify, Bikayi, Instamojo, WooCommerce, DM2buy.",
  keywords:
...
export default function Page() {
  ...
  const faqJsonLd = {
    ...
    "@type": "FAQPage",
    mainEntity: [
      { "@type": "Question", name: "Which is the cheapest ecommerce platform in India?", acceptedAnswer: { "@type": "Answer", text: "oBizee is the cheapest with zero monthly fees and 1% per order capped at \u20B910. Even for high-value orders, the maximum commission is \u20B910." } },
      ...
      { "@type": "Question", name: "Can I start an online store for free in India?", acceptedAnswer: { "@type": "Answer", text: "Yes. oBizee has no setup fees and no monthly subscription. You only pay 1% per order (max \u20B910) when you make a sale. Bikayi and DM2buy also have free tiers but with limitations." } },
