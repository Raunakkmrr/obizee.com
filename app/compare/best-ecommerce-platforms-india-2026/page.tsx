...
export default function Page() {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      { "@type": "Question", name: "Which platform has built-in shipping in India?", acceptedAnswer: { "@type": "Answer", text: "oBizee is the only platform on this list with native Delhivery and DTDC integration built into the app. Others require third-party shipping solutions." } },
