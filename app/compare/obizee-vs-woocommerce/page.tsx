...
export const metadata: Metadata = {
  ...
  description:
    "0 SUBSCRIPTION, 0 SETUP FEE, a FREE mapped custom domain and UNLIMITED products. Compare oBizee vs WooCommerce for Indian sellers. oBizee: 2-minute setup, ₹0/month, built-in Delhivery, DTDC, Blue Dart & hyperlocal. WooCommerce: requires WordPress, hosting, plugins, and technical knowledge.",
  keywords:
...
export default function Page() {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      { "@type": "Question", name: "Which is better for small Indian businesses?", acceptedAnswer: { "@type": "Answer", text: "oBizee. It's built specifically for Indian small merchants with built-in Indian courier integration, no technical requirements, 0 SUBSCRIPTION and a FREE mapped custom domain. WooCommerce is powerful but overkill for most small businesses." } },
    ],
  };
