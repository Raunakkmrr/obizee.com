...
export default function Page() {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      { "@type": "Question", name: "Does oBizee have shipping like WooCommerce?", acceptedAnswer: { "@type": "Answer", text: "Better. oBizee has native Delhivery and DTDC integration built in. WooCommerce requires third-party shipping plugins that need separate configuration." } },
