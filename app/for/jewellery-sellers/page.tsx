...
export const metadata: Metadata = {
  ...
  description:
    "Create your online jewellery store on oBizee. Sell earrings, necklaces, rings on Instagram & WhatsApp. Custom order forms for size/material options. Built-in Delhivery, DTDC & Blue Dart. 1% per order, max ₹10.",
  keywords:
